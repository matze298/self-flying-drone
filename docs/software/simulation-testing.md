...
The first concrete implementation milestone is the [software-in-the-loop (SITL) smoke test](../implementation/sitl-smoke-test.md): connect to ArduPilot Plane SITL, observe telemetry, and write a small log-only artifact without commanding the vehicle.
