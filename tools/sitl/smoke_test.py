...
class ConnectionLike(Protocol):
    """MAVLink connection fields used by the smoke test."""
...
def decode_heartbeat(connection: ConnectionLike, heartbeat: HeartbeatLike) -> HeartbeatSummary:
...
def run_smoke_test(connect: str, timeout: float, output: pathlib.Path) -> HeartbeatSummary:
    ...
    summary = decode_heartbeat(connection, heartbeat)
